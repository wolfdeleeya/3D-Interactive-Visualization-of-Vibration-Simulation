...
Generalni obrazac organizacije koda alata je obrazac model-pogled-upravljač ili MVC \engl{Model-View-Controller}. Na slici \ref{fig:high-level-overview} se može vidjeti pojednostavljeni prikaz MVC organizacije alata sa većinom ključnih klasa alata.
